      ...
      <main className="">
        ...
        <section className="py-10 md:py-20">
          <div className="container mx-auto px-4 max-w-6xl">
            <div className="mb-16">
              <h2 className="text-2xl md:text-4xl font-bold mb-6">Transform Your Vision Into Reality</h2>
              <p className="text-base text-muted-foreground leading-relaxed mb-6">
                At the heart of digital transformation lies robust software development. We specialize in creating custom applications 
                that are not only technically sound but also align perfectly with your business objectives. Our team of experienced 
                developers uses cutting-edge technologies and proven methodologies to deliver solutions that scale with your growth.
              </p>
              <p className="text-base text-muted-foreground leading-relaxed">
                Whether you need a complex enterprise system, a customer-facing web application, or a specialized tool to streamline 
                your operations, we have the expertise to bring your ideas to life. We follow agile development practices, ensuring 
                transparency, flexibility, and continuous delivery throughout the project lifecycle.
              </p>
            </div>
